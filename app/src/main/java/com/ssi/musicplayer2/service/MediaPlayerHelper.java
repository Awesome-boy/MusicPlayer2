...
//            onPlayFromUri(uri, null);
            ...
            try {
                switch (mPlaybackState.getState()) {
                    ...
                    case PlaybackStateCompat.STATE_NONE:
                        MediaPlayerReset();
                        //设置播放地址
                        mMediaPlayer.setDataSource(entity.getPath());
                        //异步进行播放
    ...
    private void updateNotification() {
        ...
        NotificationCompat.Builder notificationCompat = new NotificationCompat.Builder(mContext)
                .setContentTitle(list_data.get(last_index).getName())
                ...
                .setAutoCancel(false)
                .addAction(createAction(R.drawable.img_previous, "", AudioPlayerService.ACTION_LAST))
                .addAction(playPauseAction)
                .addAction(createAction(R.drawable.img_next, "", AudioPlayerService.ACTION_NEXT))
...
//                mediaPlayer在播放并且seebar没有被按下
    ...
    public void setPlayeData(List<MusicInfo> list_data) {
